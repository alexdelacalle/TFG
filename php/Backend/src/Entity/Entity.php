...
class Entity extends Element
{
    ...
    #[ORM\ManyToMany(targetEntity: Asociacion::class, inversedBy: "entities")]
    #[ORM\JoinTable(name: "entity_belongs_to_asociacion")]
    #[ORM\JoinColumn(name: "entity_id", referencedColumnName: "id", onDelete: "CASCADE")]
    #[ORM\InverseJoinColumn(name: "asociacion_id", referencedColumnName: "id", onDelete: "CASCADE")]
    ...
    public function removeProduct(Product $product): bool
    {
        ...
        /**
     * Obtains the associations to which the entity belongs
     *
    ...
    /**
     * Determines whether the entity belongs to the association
     *
    ...
    /**
     * Remove an association from the entity
     *
     * @param Asociacion $asociacion
     *
     * @return bool TRUE if this collection contained the specified element, FALSE otherwise.
